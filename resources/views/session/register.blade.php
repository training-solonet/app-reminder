    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-5 text-center mx-auto">
          ...
          <p class="text-lead text-white">Silakan buat akun Anda terlebih dahulu sebelum melanjutkan.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row mt-lg-n10 mt-md-n11 mt-n10">
      <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
        <div class="card z-index-0">
          <div class="card-header text-center pt-4 pb-3 mt-3">
            <h4 class="font-weight-bolder">Registrasi Akun</h4>
            <p class="mb-0">Harap lengkapi data di bawah ini</p>
          </div>
          <div class="card-body">
            <form role="form text-left" method="POST" action="/register">
              @csrf
              <div class="mb-3">
                <input type="text" class="form-control" placeholder="Nama Lengkap" name="name" id="name" aria-label="Name" aria-describedby="name" value="{{ old('name') }}">
                @error('name')
              ...
              <div class="form-check form-check-info text-left">
                ...
                @error('agreement')
                  <p class="text-danger text-xs mt-2">Anda harus menyetujui Syarat dan Ketentuan sebelum mendaftar.</p>
                @enderror
              </div>
